...
export default class SelectionToolbar extends React.Component<Props> {
  ...
  render() {
    ...
    if (isTableSelection) {
      ...
      items = getTableColMenuItems(state, colIndex, rtl, dictionary).concat(
        getFormattingMenuItems(state, isTemplate, dictionary)
      );
    } else if (rowIndex !== undefined) {
      items = getTableRowMenuItems(state, rowIndex, dictionary).concat(
        getFormattingMenuItems(state, isTemplate, dictionary)
      );
