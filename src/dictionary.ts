export const base = {
  ...
  codeInline: "Code",
  createLink: "Search or create lesson",
  createLinkError: "Sorry, an error occurred creating the link",
  createNewDoc: "Add lesson inside",
  ...
  findOrCreateDoc: "Find or create lesson",
  createChildCard: "Add lesson inside",
  ...
  mark: "Highlight",
  newLineEmpty: "Start writing, or type '/' to insert block or '[[' to add link",
